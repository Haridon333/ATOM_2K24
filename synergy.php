    ...
    <section class="faq-container" aria-label="Frequently Asked Questions">
        ...
        <details>
            ...
            <div class="faq-content">
                <p>"If you are looking for an event that challenges you to create a story line then go for it!! 
                    Piece it up where every puzzle tells a story!! Get lost in puzzles where time flies and mind flourish!! 
                    Sit back Relax and Solve the puzzle, win the battle!! Stack the cups by answering the world’s
                    happenings!!"
                </p>
                <center><h2 class="round" style="color: #000000;">Round 1 - PIXEL TALES</h2></center>
                <p>
                    Teams of two will receive two sets of questions, Set A and Set B, each containing 9 slides 
                    depicting a storyline. The task is to manually arrange the slides in the correct 
                    order to reveal the complete story.
                </p>
                <center><h2 class="round" style="color: #000000;">Round 2 - MOVIN' ON UP</h2></center>
                <p> Round 2 features 8 teams in total. Each team will receive questions, which could be generic or related
                     to current affairs, to stack cups using balloons into a pyramidal shape with 4 levels. Participants must 
                     answer questions correctly to arrange one row of cups. Four questions will be provided for each of the 4 levels.
                      If a participant fails to answer, clues will be given. The first team to pile up the cups wins!
                </p>
            </div>
        </details>
            ...
            <div class="faq-content">
                <ul style="list-style-type: none;">
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;" href=" tel:+917871188375">Pavithra S (22L250) - +91 82484 11707</a></li>
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;" href=" tel:+917010105851">Praveen Kumar G (22R255)- +91 73394 59639</a></li>
                </ul>
            </div>
        </details>
        <STYle>
...
box-shadow: 0 0 0 0 black;
        ...
        <center><button id="btn_9">Register Now</button></center>
        <br><br>
    </section>
</body>
</html>