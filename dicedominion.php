...
<body>
    ...
    <section class="faq-container" aria-label="Frequently Asked Questions">
        <center><h1>DICE DOMINION</h1></center>
        <details>
            <summary>
            ...
            <div class="faq-content">
                <p>Embark on an epic journey filled with mind-bending puzzles, each unlocking a piece of the 
                    grand mystery at the core of the adventure. This immersive game tests your problem-solving skills
                     with thrilling challenges like pattern recognition and logic puzzles. Get ready for an exhilarating ride!
                </p>
                <center><h2 class="round" style="color: #000000;">Round 1 - PUZZLE PURSUIT-</h2></center>
                <p>
                    Come join us for an eventful experience where a series of puzzles, brain-teasers, fun questions, 
                    and everything in between will make for a worthwhile investment of your time. Race against the clock 
                    to unlock a bonus question, but only if the team completes another task to gain an extra point.
                </p>
                <center><h2 class="round" style="color: #000000;">Round 2 - ROLL-RELAX RETREAT</h2></center>
                <p> Teams playing for a spot in the final round must engage in a game of “Snakes-and-Ladders,” navigating their way
                     through a giant game board adorned with a variety of tasks that either bring them closer to victory 
                     or send them sliding back to the starting line.
                </p>
            </div>
        </details>
            ...
            <div class="faq-content">
                <ul style="list-style-type: none;">
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;" href=" tel:+918220211149">Abirami SS (22D202)- 8220211149 </a></li>
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;" href=" tel:+918754808162">Nitheeshwar KK (22E139) - 8754808162 </a></li>
                </ul>
            </div>
        </details>
        <STYle>
...
box-shadow: 0 0 0 0 black;
        ...
        <center><button id="btn_10">Register Now</button></center>
        <br><br>
    </section>
</body>
</html>