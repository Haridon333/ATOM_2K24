    ...
    <section class="faq-container" aria-label="Frequently Asked Questions">
        ...
        <details>
            ...
            <div class="faq-content">
                <p>The Nexus , an electrifying immersion into the future of technology includes
                    thought provoking discussion , brain cracking quiz will be as must attend event
                    for anyone who are eager to learn, connect and to get inspired by the ever
                    evolving and competitive world of science . Eagerly looking forward for
                    everyone’s presence.</p>
                <center>
                    <h2 class="round" style="color: #000000;">Round 1 - DECIDE OR DABBLE</h2>
                </center>
                <p>
                    In this round, the participants will be given with 10 MCQ’s in sheets. The total time
                    duration for this round is 15 min. The teams which score more will be selected to the
                    next round.
                </p>
                <center>
                ...
                <center>
                    <h2 class="round" style="color: #000000;">Round 2 - MYSTERIOUS ALLEY</h2>
                </center>
                <p>The teams selected for this round are shown with collection of pictures. These
                    pictures are shown in slides which contains a scenario in which electrical
                    related things are hidden. The participants have to answer by pressing the buzzer.
                    The teams with more points will be selected to the final round.
                </p>
                <center>
            ...
            <div class="faq-content">
                <ul style="list-style-type: none;">
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;"
                            href=" tel:+916379555809">Deepak Raj MR (22R206)- 6379555809</a></li>
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;"
                            href=" tel:+919360118980">Kishore ES (22R219)- 9360118980</a></li>
                </ul>
            </div>
        </details>
        <STYle>
        ...
        <CEnter><button id="btn_6">Register Now</button></CEnter>
        <br><br>
    </section>
</body>
