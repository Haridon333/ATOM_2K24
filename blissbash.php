...
<body>
    ...
    <section class="faq-container" aria-label="Frequently Asked Questions">
        <center><h1>BLISS BASH</h1></center>
        <details>
            <summary>
            ...
            <div class="faq-content">
                <p>Teams begin with a fun and aptitude-based question in a pen-and-paper round. Once solved, they choose from three cards for themed question sets (e.g., word-find). In the next round, an electrifying audio guessing game unfolds. One team member identifies voices from 10 audio clips and provides single-word clues for teammates to guess without revealing speaker names.</p>
                <center><h2 class="round" style="color: #000000;">Round 1 - CEREBRAL CARNIVAL</h2></center>
                <p>
                    In a pen-and-paper-based round, teams will initially be presented with a common aptitude-based question to solve. Once the initial question is solved, teams will have the option to choose from two themed cards, each containing question  (e.g., word-find, situation-based idioms, etc.)sets of their own choice. Successively, one sets of question are solved according to the theme chosen by the teams.
                </p>
                <center><h2 class="round" style="color: #000000;">Round 2 - SONIC SYNC</h2></center>
                <p>        TASK 1:
                    An electrifying game where teams engage in an audio guessing activity. A set of audios featuring various artists/famous speakers (about 10 audios) are played for only one member of each team. The participant must identify the voices and give "single-worded clues" to their teammates to guess the voices. The names of speakers/voices should not be revealed.
                    
                    TASK 2: 
                    In teams of two members, one will give instructions while the other is blindfolded. The instructor should use only four key words (based on the theme) to guide the blindfolded person through obstacles. There are two or three stages, and for each stage, the instructor must solve a question to give the next instruction</p>
            </div>
        </details>
            ...
            <div class="faq-content">
                <ul style="list-style-type: none;">
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;" href=" tel:+918940389620">Karthik G(22L122)- 8940389620</a></li>
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;" href=" tel:+91 9344879203">Shivani S(22E636)- 9344879203</a></li>
                </ul>
...
box-shadow: 0 0 0 0 black;
        ...
        <center><button id="btn_8">Register Now</button></center>
        <br><br>
    </section>
</body>
</html>