    ...
    <section class="faq-container" aria-label="Frequently Asked Questions">
        ...
        <details>
            ...
            <div class="faq-content">
                <p>Unleash Your Algorithmic Alchemy & Object Enigma!
                    Round 1: Forge the most elegant solution to a hidden challenge. Pit your wit against fellow
                    minds in a clash of logic and ingenuity.
                    Round 2: Unravel the mysteries within 10 captivating images. Can you pierce the veil and
                    decipher the secrets they hold? Sharpen your perception and prove your detective prowess.Ready to
                    embark on a journey of intellectual exploration? Join us for an event where logic
                    dances with vision!
                </p>
                <center>
                    <h2 class="round" style="color: #000000;">Round 1 - ALGORITHM ALCHEMY</h2>
                </center>
                <p>
                    Calling all logic-loving students! Get ready for an adrenaline-pumping competition where your
                    teamwork and
                    logical skills will be put to test.
                </p>
                <center>
                ...
                <center>
                    <h2 class="round" style="color: #000000;">Round 2 - FEATURE FORENSICS</h2>
                </center>
                <p> Behold, explorers of the past! Are you ready to embark on a captivating quest where history meets
                    technology? 10 enigmatic images hold the secrets of forgotten inventions. Each image showcases a
                    rare technological instrument from a bygone era, its name lost to the sands of time. Can you crack
                    the code and unearth their identities using the power of AI? Challenge yourself and your team to
                    sharpen your observation skills, unleash AI's knowledge, and to work swiftly and collaboratively.
                ...
                <p>
                    • Total No. Of Tasks :1 (find the name of the objects in the 10 images)
                    <br>
                    • Total Time Allotted - 40 minutes
                </p>
            </div>
        ...
        <details>
            ...
            <div class="faq-content">
                <h4 class="date" style="color: rgb(0, 0, 0);">20/03/24</h4>
            </div>
        </details>
            ...
            <div class="faq-content">
                <ul style="list-style-type: none;">
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;"
                            href=" tel:+919092526730">Subash karthick V (22L149)- 9092526730</a></li>
                    <li><a style="color: #000000;text-transform: uppercase;text-decoration: none;"
                            href=" tel:+918825866273">Harshita V (22E123)- 8825866273</a></li>
                </ul>
            </div>
        </details>
        <style>
        ...
        <center><button id="btn_4">Register Now</button></center>
        <br><br>
    </section>
</body>
